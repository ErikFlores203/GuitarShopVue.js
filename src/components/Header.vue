...
import {computed} from 'vue'
    ...
    defineEmits(['incrementar-cantidad', 'decrementar-cantidad','agregar-carrito','eliminar-producto','eliminar-carrito'])
                    ...
                    >
                        ...
                        <div id="carrito" class="bg-white p-3">
                            ...
                            <div v-else>
                                ...
                                <button class="btn btn-dark w-100 mt-3 p-2" @click="$emit('eliminar-carrito')" >Vaciar Carrito</button>
                            </div>
